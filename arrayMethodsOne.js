...
// CODE HERE
// const evenNumbers = mixedNumbers.filter((num, i, arr) => {
//   return num % 2 === 0
// })

const evenNumbers = mixedNumbers.filter(num => num % 2 === 0)

// const evenNumbers = mixedNumbers.filter(function(num, i, array){
//   return num % 2 === 0
// })
...
// CODE HERE
// const postTaxPrices = prices.map(function(num, i, arr){
//   return num = num * 1.07
// })
...
// CODE HERE
const totalPopulation = populations.reduce((acc, cur, i, arr) => {
  return acc + cur 
} )
...
// CODE HERE  *** if it evaluates to FALSE, it will NOT include into new array
...
const totalOrder = orders.map((elem) => {
  return elem.price + (elem.price * elem.tax)
})

console.log(totalOrder)

//implicit return: get rid of curly brack and return.....((elem) => elem.price +....)
