...
/* 
    Use forEach method to loop though all the elements in the 'numbers' array above, and 
    divide each element (number) by 2. Print the result in console.
*/

// CODE HERE
numbers.forEach((elem, i, arr) => console.log(elem /2))


////////// PROBLEM 2 //////////

/* 
    Use a built-in Javascript method that will loop through the 'numbers' array above, divide each number by 2, 
...
// CODE HERE
const divByTwo = numbers.map(num => num / 2)
...
// CODE HERE
const filteredArr = cities.filter((city, i, arr) => {
...
/* 
    ...
    If the color is red, print "The fruit with index [THE ELEMENT'S INDEX] is an apple." If the color is orange, 
    print "The fruit with index [THE ELEMENT INDEX] is an orange." If the color is not red or apple, print "The fruit 
    with index [THE ELEMENT'S INDEX] is neither apple or orange."

    Note: do a google search on how to find an element's index of an array in Javascript. There is a built-in Javascript 
    method that would help you find an index of an element in an array.
*/
...
// CODE HERE
const riceTag = foods.filter((food, i, arr) => {
  return food.tags.includes('rice')
})

const totalPrice = riceTag.reduce((acc, cur, i, arr) => {
